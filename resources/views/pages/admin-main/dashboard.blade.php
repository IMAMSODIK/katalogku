                  ...
                  <div class="col-md-12 col-sm-6">
                    <div class="card boost-up-card overflow-hidden">
                      <div class="p-4">
                        ...
                        <div class="img-boostup"><img class="img-boostup-img-1" src="{{ asset('assets/riho-asset/images/dashboard-3/boostup1.png') }}" alt="boostup"><img class="img-boostup-img-2" src="{{ asset('assets/riho-asset/images/dashboard-3/boostup2.png') }}" alt="boostup"></div>
                    ...
                    <div class="card">
                      <div class="card-header card-no-border total-revenue pb-0">
                        ...
                        <div class="icon-menu-header">
                          <svg>
                            <use href="{{ asset('assets/riho-asset/svg/icon-sprite.svg#more-horizontal') }}"></use>
                          </svg>
                        </div>
                      </div>
                      <div class="card-body pt-0">
                    ...
                    <div class="top-product-card">
                      <ul>
                        <li class="d-flex top-product gap-2">
                          <div><img class="img-fluid product-img" src="{{ asset('assets/riho-asset/images/dashboard-3/product/1.png') }}" alt="product"/></div>
                        ...
                        <li class="d-flex top-product gap-2">
                          <div><img class="img-fluid product-img" src="{{ asset('assets/riho-asset/images/dashboard-3/product/2.png') }}" alt="product"/></div>
                          <div class="w-100 d-flex justify-content-between align-items-center">
                            <div class="product-details">
                        ...
                        <li class="d-flex top-product gap-2">
                          <div><img class="img-fluid product-img" src="{{ asset('assets/riho-asset/images/dashboard-3/product/3.png') }}" alt="product"/></div>
                          <div class="w-100 d-flex justify-content-between align-items-center">
                            <div class="product-details">
                        ...
                        <li class="d-flex top-product gap-2">
                          <div><img class="img-fluid product-img" src="{{ asset('assets/riho-asset/images/dashboard-3/product/4.png') }}" alt="product"/></div>
                          <div class="w-100 d-flex justify-content-between align-items-center">
                            <div class="product-details">
                ...
                <div class="card height-equal">
                  ...
                  <div class="card-body pt-0">
                    <div class="new-user">
                      <ul>
                        <li>
                          <div class="space-common d-flex user-name"><img class="img-40 rounded-circle img-fluid me-2" src="{{ asset('assets/riho-asset/images/user/22.png') }}" alt="user"/>
                                ...
                                <div class="dropdown">
                                  <div id="dropdownMenuButtonicon31" data-bs-toggle="dropdown" aria-expanded="false" role="menu">
                                    <svg class="invoice-icon">
                                      <use href="{{ asset('assets/riho-asset/svg/icon-sprite.svg#more-vertical') }}"></use>
                                    </svg>
                                  </div>
                        ...
                        <li>
                          <div class="space-common d-flex user-name"><img class="img-40 rounded-circle img-fluid me-2" src="{{ asset('assets/riho-asset/images/user/28.png') }}" alt="user"/>
                            <div class="common-space w-100">
                              <div>
                        ...
                        <li>
                          <div class="space-common d-flex user-name"><img class="img-40 rounded-circle img-fluid me-2" src="{{ asset('assets/riho-asset/images/user/26.png') }}" alt="user"/>
                            <div class="common-space w-100">
                              <div>
                        ...
                        <li>
                          <div class="space-common d-flex user-name"><img class="img-40 rounded-circle img-fluid me-2" src="{{ asset('assets/riho-asset/images/user/24.png') }}" alt="user"/>
                            <div class="common-space w-100">
                              <div>
                        ...
                        <li>
                          <div class="space-common d-flex user-name"><img class="img-40 rounded-circle img-fluid me-2" src="{{ asset('assets/riho-asset/images/user/49.png') }}" alt="user"/>
                            <div class="common-space w-100">
                              <div>
                              ...
                              <div class="team-activity">
                                <div class="activity-data d-flex align-items-center gap-3">
                                  <div class="common-space gap-2 ">
                                    <div class="user-activity me-3"><img class="rounded-circle p-1 img-fluid me-3 img-50" src="{{ asset('assets/riho-asset/images/user/50.png') }}" alt="user"><a class="f-10 f-w-500 username" href="edit-profile.html">Floyd Miles</a></div>
                          ...
                          <tr>
                            <td>
                              <div class="team-activity">
                                <div class="activity-data d-flex align-items-center gap-3">
                                  <div class="common-space gap-2 ">
                                    <div class="user-activity me-3"><img class="rounded-circle p-1 img-fluid me-3 img-50" src="{{ asset('assets/riho-asset/images/user/51.png') }}" alt="user"><a class="f-10 f-w-500 username" href="edit-profile.html">Ralph Edwards</a></div>
                          ...
                          <tr>
                            <td>
                              <div class="team-activity">
                                <div class="activity-data d-flex align-items-center gap-3">
                                  <div class="common-space gap-2 ">
                                    <div class="user-activity me-3"><img class="rounded-circle p-1 img-fluid me-3 img-50" src="{{ asset('assets/riho-asset/images/user/33.png') }}" alt="user"><a class="f-10 f-w-500 username" href="edit-profile.html">Esther Howard</a></div>
                          ...
                          <tr>
                            <td>
                              <div class="team-activity">
                                <div class="activity-data d-flex align-items-center gap-3">
                                  <div class="common-space gap-2 ">
                                    <div class="user-activity me-3"><img class="rounded-circle p-1 img-fluid me-3 img-50" src="{{ asset('assets/riho-asset/images/user/52.png') }}" alt="user"><a class="f-10 f-w-500 username" href="edit-profile.html">Jacob Jones</a></div>
                          ...
                          <tr>
                            <td>
                              <div class="team-activity">
                                <div class="activity-data d-flex align-items-center gap-3">
                                  <div class="common-space gap-2 ">
                                    <div class="user-activity me-3"><img class="rounded-circle p-1 img-fluid me-3 img-50" src="{{ asset('assets/riho-asset/images/user/53.png') }}" alt="user"><a class="f-10 f-w-500 username" href="edit-profile.html">Theresa Webb</a></div>
                          ...
                          <tr>
                            <td>
                              <div class="team-activity">
                                <div class="activity-data d-flex align-items-center gap-3">
                                  <div class="common-space gap-2 ">
                                    <div class="user-activity me-3"><img class="rounded-circle p-1 img-fluid me-3 img-50" src="{{ asset('assets/riho-asset/images/user/54.png') }}" alt="user"><a class="f-10 f-w-500 username" href="edit-profile.html">Annette Black</a></div>
                                    <div class="activity-time"><span class="f-light f-w-500 f-10">12 min ago</span></div>
                                  </div>
                                  <div class="subtitle">
                  ...
                  <div class="card-footer">
                    <div class="common-space">
                      ...
                      <div class="visited-dropdown">
                        <svg class="mb-0">
                          <use href="{{ asset('assets/riho-asset/svg/icon-sprite.svg#arrow-down') }}"></use>
                        </svg>
                      </div>
                    </div>
                  </div>
...
$(document).ready(function() {
    // Check for pending checkout data in localStorage
    ...
    if (pendingCheckout) {
        try {
            ...
            // Save pending checkout to database
            $.ajax({
                ...
                data: JSON.stringify({
                    template_name: checkoutData.name,
                    template_type: checkoutData.type,
                    price: checkoutData.price,
                    status: 'pending',
                    features: checkoutData.features || [],
                    purchase_date: checkoutData.timestamp || new Date().toISOString()
                }),
                success: function(response) {
                    console.log('Pending checkout saved successfully:', response);
                    ...
                    if (typeof toastr !== 'undefined') {
                        toastr.success('Template checkout berhasil disimpan! Silakan lanjutkan pembayaran.');
                    } else {
                        alert('Template checkout berhasil disimpan! Silakan lanjutkan pembayaran.');
                    }
                ...
                error: function(xhr, status, error) {
                    ...
                    // Don't remove localStorage on error, so user can try again
                    if (typeof toastr !== 'undefined') {
                        toastr.error('Gagal menyimpan data checkout. Silakan coba lagi.');
                    } else {
                        alert('Gagal menyimpan data checkout. Silakan coba lagi.');
                    }
                }
            });
        } catch (e) {
